...
class alCommand extends Command {
  ...
  hasPermission(message) {
    if (message.guild && (message.guild.id == '268970339948691456' || message.guild.id == '364460985689440256') && (message.client.settings.get(message.guild.id).isDonator == true || message.author.id == require('../../config.json').owner)) return true
    return false
  }
