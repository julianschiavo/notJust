...
class startCommand extends Command {
  ...
  async run(message, args, api) {
    ...
    var inv = chan.createInvite({maxAge:0,unique:true},'Gold Bar Invite for ' + message.author.tag)
    
    chan2.send('<:gold:383074743089364992> Created **Gold Bar Invite** for' + message.author.tag)
